          ...
          <div className="absolute bottom-0 left-0 right-0 text-center">
            ...
            >
              <div className="inline-flex items-center gap-2 sm:gap-3 relative">
                <motion.span 
                  className="text-sky-600 font-bold text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl tracking-wider"
                ...
                <span className="text-gray-300 font-light text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl">×</span>
                <motion.span 
                  className="text-cyan-600 font-bold text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl tracking-wider"
