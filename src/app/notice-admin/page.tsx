...
export default function AdminAnnouncementsPage() {
  ...
  const handleBulkDelete = async () => {
    ...
    if (!confirm(`선택한 ${selectedIds.size}개의 공지사항을 정말 삭제하시겠습니까?`)) return;
    ...
    try {
      ...
      if (failed.length > 0) {
        alert(`${failed.length}개의 공지사항 삭제에 실패했습니다`);
      } else {
        alert(`${selectedIds.size}개의 공지사항이 삭제되었습니다`);
          ...
          <div className="flex gap-3">
            ...
            {selectedIds.size > 0 && (
              <button
                ...
                className="bg-red-600 text-white px-6 py-2.5 hover:bg-red-700 transition-colors"
              >
            ...
            <div className="border-b border-gray-300 bg-gray-50">
              <div className="grid grid-cols-12 gap-4 px-6 py-4 text-sm font-semibold text-gray-700">
                <div className="col-span-1 text-center">
                  <input
                    type="checkbox"
                    checked={announcements.length > 0 && selectedIds.size === announcements.length}
                    onChange={(e) => {
                      if (e.target.checked) {
                  ...
                  <div className="col-span-1 text-center">
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        if (e.target.checked) {
                          newSelected.add(announcement.id);
                        } else {
                          newSelected.delete(announcement.id);
                        }
